...
local warnPortalsWillBeClosing	= mod:NewAnnounce("WarnPortalsWillBeClosing", 4, 72483)
...
local timerPortalsWillBeClosing	= mod:NewTimer(10, "TimerPortalsWillBeClosing", 72483)
...
function mod:Portals()
	...
	timerPortalsWillBeClosing:Cancel()
	warnPortalSoon:Cancel()
	warnPortalsWillBeClosing:Schedule(15)
	timerPortalsWillBeClosing:Schedule(15)
	warnPortalSoon:Schedule(41)
	timerNextPortal:Start()
